  ...
  const pastEvents = [
    {
      ...
      description: 'A high-energy innovation hackathon designed to unlock creativity, push technical limits, and help participants vibe with like-minded problem solvers as they built futuristic solutions in just 24 hours.',
      category: 'Hackathon',
      attendees: "160-200",
    ...
    },
    {
      ...
      attendees: 100,
      image:
        'https://media.licdn.com/dms/image/v2/D5622AQH2ejT8B7OPxw/feedshare-shrink_800/B56ZYMT71KHEAo-/0/1743963276782?e=1773878400&v=beta&t=t4qdlduMb-8PuDUktUYdAyXr_R81nAVP9aDVY9QLPls',
    ...
    },
    {
      ...
      attendees: 150,
      image:
        'https://media.licdn.com/dms/image/v2/D5622AQEotnxtPmWuwg/feedshare-shrink_2048_1536/B56ZW_b0J8HsAo-/0/1742673496595?e=1773878400&v=beta&t=ZRhqM_lyVF0ntM2tAfL0yqspvQUKCyejzq1uIFbfCy0',
      ...
      <section className="py-6 text-center">
        <div className="inline-flex gap-4 bg-gray-100 p-2 rounded-full">
          <button
            ...
            className={`px-5 py-2 rounded-full font-medium transition ${showUpcoming ? 'bg-[#0078D4] text-white' : 'text-[#0078D4] hover:bg-[#0078D4]/10'
              }`}
          >
            Upcoming Events
          </button>
